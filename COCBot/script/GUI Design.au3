...
$txtLog = _GUICtrlRichEdit_Create($frmBot, "", 16, 40, 385, 230, BitOR($ES_MULTILINE, $ES_READONLY, $ES_AUTOVSCROLL, $WS_VSCROLL, $ES_NOHIDESEL))
...
$Conditions = GUICtrlCreateGroup("Conditions", 16, 40, 185, 185)
