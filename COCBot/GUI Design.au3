...
$Controls = GUICtrlCreateGroup("Controls", 16, 270, 185, 85)
$btnStart = GUICtrlCreateButton("Start", 30, 332, 75, 20)
GUICtrlSetOnEvent(-1, "btnStart")
$btnStop = GUICtrlCreateButton("Stop", 30, 332, 75, 20)
GUICtrlSetOnEvent(-1, "btnStop")
GUICtrlSetState(-1, $GUI_HIDE)
$btnHide = GUICtrlCreateButton("Hide", 110, 332, 75, 20)
GUICtrlSetOnEvent(-1, "btnHide")
GUICtrlSetState(-1, $GUI_DISABLE)
$chkBotStop = GUICtrlCreateCheckbox("", 37, 289, 16, 16)
$cmbBotCommand = GUICtrlCreateCombo("", 55, 285, 110, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "Halt Attack Mode|Shutdown PC|Sleep PC", "Halt Attack Mode")
$lblPC = GUICtrlCreateLabel("IF :", 168, 289, 55, 17)
$cmbBotCond = GUICtrlCreateCombo("", 31, 309, 153, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
